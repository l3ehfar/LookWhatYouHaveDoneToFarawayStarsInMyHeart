...
function draw() {
  ...
  amp2 = map(level, 0, 0.5, amp, 2.5*amp);
}if(counter>70000){
  amp2 = map(level, 0, 0.5, amp, amp*3);
  amp = 1.0
  amp4 = map(level, 0, 0.5, amp, amp*2);
}if(counter>97000){
  amp2 = map(level, 0, 0.5, amp, amp*5);
  amp = 1.0
  amp4 = map(level, 0, 0.5, amp, amp*3);
}if(counter>128000){
  amp2 = map(level, 0, 0.5, amp, amp*4);
  amp4 = map(level, 0, 0.5, amp, amp*2);
  amp3 = map(level,0,1, amp, amp*1);
}if(counter>155000){
  amp4 = map(level, 0, 0.5, amp, amp*4);
  amp3 = map(level,0,1, amp, amp*2.5);
}if(counter>210000){
